...
//             foreach (var character in turnInstance.characterLists)
//             {
//                 if (character.GetActorStateTag() ==
//                     ActorEnumType.ActorStateTag.Player)
//                 {
//                     return new AttackActorCommand(ActorsManagerCenter.Instance.GetActorByDynamicId(character.DynamicId));
//                 }
//             }
//         }
//
