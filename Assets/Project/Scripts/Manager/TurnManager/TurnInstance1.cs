...
//     public TurnInstance1(bool isGameModeTurn = false)
//     {
...
//     /// <param name="isGameModeTurn">是否为手动切换的gamemode，缺省false</param>
//     public TurnInstance1(List<uint> conActorDynamicIDs, bool isGameModeTurn = false)
//     {
//         this.isGameModeTurn = isGameModeTurn;
//
//         InitListen();
...
//         {
//             actorsManagerCenter.GetActorByDynamicId(id).SetTurnIntance(this);
